...
setProducts(Array.isArray(p)? p : p.id ?? [])
setSaved(Array.isArray(q)? q : q.id ??[])
                    ...
                    {saved.map(q => (
                        <TableRow key={q.id}>
                            ...
                            <TableCell className="text-right space-x-2">
                                ...
                                <Button variant="outline" size="icon" onClick={()=>deleteQuotation(q.id)}><Trash2 size={16} className="text-destructive"/></Button>
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
